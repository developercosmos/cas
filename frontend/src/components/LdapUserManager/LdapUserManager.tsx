...
import styles from './LdapUserManager.module.css';
...
interface LdapUserManagerProps {
  onClose: () => void;
  configId: string;
}
...
const LdapUserManager: React.FC<LdapUserManagerProps> = ({ onClose, configId }) => {
...
export default LdapUserManager;
